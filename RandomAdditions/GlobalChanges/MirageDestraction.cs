...
namespace RandomAdditions
{
    public class MirageDestraction : Destraction
    {
        ...
        internal override bool GetPosDistract(Vector3 pos, out Vector3 dis2)
        {
        ...
        internal class MirageTank : MonoBehaviour
        {
            ...
            public void Init(Tank tank, MirageDestraction control, Vector3 Offset, int accuracyCalced)
            {
                tech = tank;
                offset = Offset;
